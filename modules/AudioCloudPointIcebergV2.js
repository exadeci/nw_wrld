/*
@nwWrld name: AudioCloudPointIcebergV2
@nwWrld category: Audio
@nwWrld imports: BaseThreeJsModule, THREE, createNoise2D, createNoise3D, AudioAnalyzer
*/

class AudioCloudPointIcebergV2 extends BaseThreeJsModule {
  static name = "AudioCloudPointIcebergV2";
  ...
  constructor(container) {
    ...
    this.name = AudioCloudPointIcebergV2.name;
  ...
  audioAnimate() {
    ...
    this.targetScale = 1 + this.bass * 0.4;
    this.baseScale += (this.targetScale - this.baseScale) * 0.1;
    this.customGroup.scale.setScalar(this.baseScale);

    const rotSpeed = this.rotationSpeed + this.volume * 0.015;
    this.customGroup.rotation.y += rotSpeed;
    this.customGroup.rotation.x += rotSpeed * 0.4;

    if (this.pointCloud && this.pointCloud.material) {
      this.pointCloud.material.size = 0.03 + this.treble * 0.04;
    }

    if (this.wireMesh && this.wireMesh.material) {
      this.wireMesh.material.opacity = 0.3 + this.mid * 0.4;
    }
...
export default AudioCloudPointIcebergV2;
