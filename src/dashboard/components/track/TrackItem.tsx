...
import { TrackDataModal } from "../../modals/TrackDataModal.tsx";
import { ModuleSelector, SortableModuleItem } from "./ModuleComponents.tsx";
...
export const TrackItem = React.memo(
  ({
    ...
    const handleAddChannel = useCallback(() => {
      ...
      if (!nextChannel) {
        alert("All 20 channels are already in use.");
        return;
      }
